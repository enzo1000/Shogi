...
#En python, les variables on 2 niveaux de portes, local ou global.
#En fonction de leur niveau, les variables vont etre repertories dans la commande globals() ou locales()
#Ce sont toutes deux des dictionnaires repertoriant de nombreuses methodes, variables et scripts ...
#Ces deux dictionnaires ne sont pas utilises explicitement ici mais implicitement lors d appel de variables (ce commentaire est a titre informatif)
